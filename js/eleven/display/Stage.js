...
Stage.prototype = new EventDispatcher();
Stage.prototype.constructor = Stage;
function Stage(canvasID, stageWidth, stageHeight){
    ...
    function supported(canvas){ 
        ...
        if (canvas){
			...
			backBuffer.width = stageWidth;
			backBuffer.height = stageHeight;
	...
	this.clearFrame = function(){
		backBufferContext2D.clearRect(0, 0, stageWidth, stageHeight);
		context2D.clearRect(0, 0, stageWidth, stageHeight);	
	};
    this.draw = function(){
